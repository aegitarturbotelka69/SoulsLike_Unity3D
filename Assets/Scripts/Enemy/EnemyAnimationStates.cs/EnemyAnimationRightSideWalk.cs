...
{
    public class EnemyAnimationRightSideWalk : StateMachineBehaviour
    {
        [Header("References:")]
        [SerializeField] private EnemyAI _ai;

        [Header("Stats")]
        [SerializeField] private float _rightSideWalkSpeedMultiplier = 4.5f;
